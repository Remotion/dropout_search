...
namespace Dropout
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.labelStatus.Location = new System.Drawing.Point(128, 442);
            this.labelStatus.Name = "labelStatus";
            this.labelStatus.Size = new System.Drawing.Size(546, 19);
            ...
            this.listViewResults.Size = new System.Drawing.Size(660, 192);
            ...
            this.listViewResults.MouseUp += new System.Windows.Forms.MouseEventHandler(this.listViewResults_MouseUp);
            // 
            // columnHeaderIcon
            // 
            ...
            this.tabControl1.Size = new System.Drawing.Size(662, 198);
            ...
            this.tabPage1.Size = new System.Drawing.Size(654, 169);
            ...
            this.pictureBox2.Location = new System.Drawing.Point(488, 80);
            ...
            this.textBoxQuery.Size = new System.Drawing.Size(321, 22);
            ...
            this.buttonSearch.Location = new System.Drawing.Point(249, 116);
            ...
            this.tabPage2.Size = new System.Drawing.Size(654, 169);
            ...
            // textBoxType
            // 
            this.textBoxType.Location = new System.Drawing.Point(75, 133);
            ...
            this.pictureBox3.Location = new System.Drawing.Point(261, 11);
            this.pictureBox3.Name = "pictureBox3";
            this.pictureBox3.Size = new System.Drawing.Size(135, 62);
            ...
            this.dateTimePickerTo.Location = new System.Drawing.Point(526, 133);
            ...
            this.dateTimePickerFrom.Location = new System.Drawing.Point(338, 133);
            ...
            this.buttonSearch1.Location = new System.Drawing.Point(466, 72);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textBoxContent.Location = new System.Drawing.Point(75, 74);
            this.textBoxContent.Name = "textBoxContent";
            this.textBoxContent.Size = new System.Drawing.Size(385, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textBoxName.Location = new System.Drawing.Point(75, 102);
            ...
            this.label5.Location = new System.Drawing.Point(503, 136);
            ...
            this.labelSearch.Location = new System.Drawing.Point(12, 414);
            this.labelSearch.Name = "labelSearch";
            this.labelSearch.Size = new System.Drawing.Size(654, 20);
            ...
            this.buttonRefreshIndex.Location = new System.Drawing.Point(12, 437);
            ...
            this.pictureBoxCredits.Location = new System.Drawing.Point(647, 5);
            ...
            // buttonToday
            // 
            this.buttonToday.Location = new System.Drawing.Point(444, 133);
            ...
            this.MinimumSize = new System.Drawing.Size(702, 480);
            this.Name = "frmMain";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            if (File.Exists(iniPath))
            {
                ...
                try
                {
                    string explorer = ini.IniReadValue("Options", "Explorer Menu");
                    if (!string.IsNullOrEmpty(explorer))
                        explorerMenu = bool.Parse(explorer);
                }
                catch
                {
                    MessageBox.Show("The Explorer Menu setting has an invalid value, should be true or false", "Explorer Menu", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
        ...
        void Index()
        {
            ...
            indexWorker.DoWork += delegate(object sender, DoWorkEventArgs e)
            {
                ...
                if (checkIndex())
                {
                    ...
                    IndexReader indexReader = IndexReader.Open(this.pathIndex, true);
                ...
                while (attempts < 5)
                {
                    ...
                    if (checkIndex())
                    {
                        ...
                        try
                        {
                            indexWriter = new IndexWriter(FSDirectory.GetDirectory(pathIndex), new StandardAnalyzer(), false);
                            attempts = 5;
                        }
                    ...
                    {
                        indexWriter = new IndexWriter(FSDirectory.GetDirectory(pathIndex), new StandardAnalyzer(), true);
                        attempts = 5;
                    }
		...
		private bool checkIndex()
		{
			try 
			{
				searcher = new IndexSearcher(pathIndex, true);
				searcher.Close();
                return true;
			}
			catch (IOException)
		...
		private void Search()
		{
            ...
            searchWorker.DoWork += delegate(object sender, DoWorkEventArgs e)
            {
                ...
                try
                {
                    searcher = new IndexSearcher(this.pathIndex, true);
                }
                ...
                for (int i = 0; i < hits.Length(); i++)
                {
                    ...
                    ListViewItem item = new ListViewItem(new string[] { null, filename, (hits.Score(i) * 100).ToString("N0"), modified.ToShortDateString() + " " + modified.ToShortTimeString(), folder });
                    item.Tag = path;
                    try
                    {
        ...
        {
            if (explorerMenu == false || e.Button != System.Windows.Forms.MouseButtons.Right)
            {
                return;
            }
            ListViewHitTestInfo hitTest = listViewResults.HitTest(e.X, e.Y);
            if (hitTest.Item == null)
            {
                return;
            }
            string path = (string)hitTest.Item.Tag;
            ...
            foreach (string searchDir in searchDirs)
            {
                ...
                if (File.Exists(fullPath))
                {
                    ...
                    Peter.ShellContextMenu contextMenu = new Peter.ShellContextMenu();
                    Point contextMenuLocation = listViewResults.PointToScreen(new Point(e.X, e.Y));
                    contextMenu.ShowContextMenu(new FileInfo[] { fi }, contextMenuLocation);
                    return;
                }
            }
